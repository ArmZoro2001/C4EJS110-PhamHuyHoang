...
// };
// //ex3.1
// console.log('the outermost layer is object')
// //ex3.2
// console.log('The hits property is array')
// //ex3.3
// console.log('dùng hit + "." + title, locations, salary, benefits, skills and requirements')
//ex4
// {const dictionary = {
...
// }
// dictionary['ui/ux'] = 'UI means User Interface, UX mean User Experience, are the process to define how your products looks and feels';
...
//     },
//     ]
    // for(let x of smarthPhone){
    //     console.log('Name :'+ x.Name);
    //     console.log('Price : ' + x.Price);
    //     console.log('--------------------------------------')
    // }
    //5.2
    //     for(let i in smarthPhone){
    //         var {Name,Price}=smarthPhone[i];
    //         console.log(`#${Number(i)+1}. ${Name}\nPrice : ${Price}`)
    //     }
    
    // let index = Number(prompt(' Nhập vị trí muốn xem :'))
    //     console.log(smarthPhone[index - 1])
    //5.3
    ...
    //     }
    //5.4
//     smarthPhone[0].Providers = 'Phukienzero\nDientuccc';
//     smarthPhone[1].Providers = 'Tgdd\nDdghn\nVhStore ';
//     smarthPhone[2].Providers = 'Tgdd';
//     smarthPhone[3].Providers = 'Tgdd';
//     let i = 0;
//     for (let x of smarthPhone){
//         console.log(`#${Number(i)+1}. ${x.Name}\nPrice : ${x.Price}\n Providers : ${x.Providers}`)
//         i++;
//     }
// }
//6.1
